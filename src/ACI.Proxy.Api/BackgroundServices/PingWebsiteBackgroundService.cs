...
namespace ACI.Proxy.Api.BackgroundServices
{
    public class PingWebsiteBackgroundService : BackgroundService
    {
        ...
        public PingWebsiteBackgroundService(IHttpClientFactory httpClientFactory, ILogger<PingWebsiteBackgroundService> logger, IOptions<PingWebsiteSettings> configuration)
        {
