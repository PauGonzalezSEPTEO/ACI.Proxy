...
export class RoomTypeListingComponent implements OnInit, OnDestroy {
  ...
  loadBuildingsForProjects() {
    const projectIds = this.roomTypeModel.getRelevantProjectIds();
  ...
  loadProjectsForSelectedCompanies() {
    ...
    this.projectService.getByCompanyIds(selectedCompanyIds).subscribe(projects => {
      const selectedProjectIds = this.roomTypeModel.projects;
      this.roomTypeModel.projectsList = projects
      this.roomTypeModel.projects = projects
