...
export class BoardListingComponent implements OnInit, OnDestroy {  
  ...
  loadBuildingsForProjects() {
    const projectIds = this.boardModel.getRelevantProjectIds();
  ...
  loadProjectsForSelectedCompanies() {
    ...
    this.projectService.getByCompanyIds(selectedCompanyIds).subscribe(projects => {
      const selectedProjectIds = this.boardModel.projects;
      this.boardModel.projectsList = projects
      this.boardModel.projects = projects
