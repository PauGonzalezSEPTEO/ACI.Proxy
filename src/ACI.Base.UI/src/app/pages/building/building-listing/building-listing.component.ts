...
export class BuildingListingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private apiService: BuildingService, private hotelService: HotelService, public authService: AuthService, private cdr: ChangeDetectorRef, private translate: TranslateService) { }
  ...
  ngOnInit(): void {
    this.hotelService.search('', '', this.translate.currentLang).subscribe((hotels: Hotel[]) => {
    ...
    this.datatableConfig = {
      ...
      columns: [
        ...
        {
          title: this.translate.instant('BUILDINGS.LIST.HOTEL'), name: "BUILDINGS.LIST.HOTEL", data: 'hotelName', type: 'string'
        }
      ],
