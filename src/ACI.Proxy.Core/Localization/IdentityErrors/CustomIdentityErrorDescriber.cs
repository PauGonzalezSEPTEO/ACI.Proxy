...
namespace ACI.Proxy.Core.Localization.IdentityErrors
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        private readonly IStringLocalizer<CustomIdentityErrors> _localizer;

        public CustomIdentityErrorDescriber(IStringLocalizer<CustomIdentityErrors> localizer)
        {
        ...
        public override IdentityError DefaultError()
        {
            return new IdentityError
            {
                ...
                Description = _localizer["DefaultIdentityError"]
            };
        }
    }
}
