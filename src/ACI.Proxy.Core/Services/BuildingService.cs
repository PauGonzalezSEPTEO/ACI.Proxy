...
namespace ACI.Proxy.Core.Services
{
    ...
    {
        Task<List<BuildingDto>> ReadByProjectIdsAsync(int[] projectIds, string languageCode = null, CancellationToken cancellationToken = default);
    }
    ...
    public class BuildingService : IBuildingService
    {
        ...
        public async Task<List<BuildingDto>> ReadByProjectIdsAsync(int[] projectIds, string languageCode = null, CancellationToken cancellationToken = default)
        {
            var query = _baseContext.Buildings
