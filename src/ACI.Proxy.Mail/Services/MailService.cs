...
namespace ACI.Proxy.Mail.Services
{
    ...
    public class MailService : IMailService
    {
        ...
        public MailService(IOptions<MailSettings> mailSettings, IStringLocalizer<MailService> localizer, IDataProtectionProvider dataProtectionProvider, IOptions<UISettings> uiSettings, MailTemplateHelper mailTemplateHelper)
        {
        ...
        public async Task<bool> SendMailAsync(SendMailDto sendMailDto, CancellationToken cancelationToken = default)
        {
            try
            {
                ...
                using (var smtp = new SmtpClient())
                {
                    ...
                    {
                        string password = _dataProtector.Unprotect(_mailSettings.Password);
                        await smtp.AuthenticateAsync(_mailSettings.UserName, password, cancelationToken);
